<div class="content">
	...
	<ul>
	    <li><a href="https://swupdate.openvpn.org/community/releases/openvpn-install-2.4.0-I601.exe">OpenVPN-GUI Download</a></li>
	    <li><a href="https://openvpn.net/index.php/access-server/docs/admin-guides-sp-859543150/howto-connect-client-configuration/395-how-to-install-the-openvpn-client-on-windows.html">How-to install OpenVPN Client</a></li>
	</ul>
    </p>
    <p>OSX: <a href="https://tunnelblick.net/downloads.html">TunnelBlick</a></p>
    <p>Linux: Check your package manager or have a look at the <a href="https://community.openvpn.net/openvpn/wiki/OpenvpnSoftwareRepos">OpenVPN Debian and Ubuntu Repos</a></p>

    <h6>Mobile</h6>
    <p>iOS: <a href="https://itunes.apple.com/us/app/openvpn-connect/id590379981?mt=8">OpenVPN Connect (App Store)</a></p>
    <p>Android: <a href="https://play.google.com/store/apps/details?id=net.openvpn.openvpn&hl=en">OpenVPN Connect (Google Play)</a></p>
